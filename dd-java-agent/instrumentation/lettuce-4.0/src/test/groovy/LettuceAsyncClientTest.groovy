...
import static datadog.trace.instrumentation.lettuce4.LettuceInstrumentationUtil.AGENT_CRASHING_COMMAND_PREFIX
...
//  }
  ...
  def "connect exception inside the connection future"() {
    ...
    when:
    RedisAsyncCommands<String, String> connection = testConnectionClient.connect(new RedisURI(HOST, incorrectPort, 3, TimeUnit.SECONDS)).async()
